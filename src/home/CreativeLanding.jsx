                ...
                <header className="header-area formobile-menu header--fixed default-color">
                    <div className="header-wrapper" id="header-wrapper">
                        <div className="header-left">
                            <div className="logo">
                                <a href="/">
                                    <img className="logo-1" src="/assets/images/logo/ATX_Logo_6dcef0.png" alt="Logo Images"/>
                                    {/* <img src="/assets/images/logo//ATX Float_Logo 2/ATX Logo_6dcef0.png" alt="Digital Agency" /> */}
                                    <img className="logo-2" src="/assets/images/logo//ATX_Logo_6dcef0.png" alt="Logo Images"/>
                                </a>
                            </div>
                        </div>
