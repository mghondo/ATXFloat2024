                ...
                <div className="header-wrapper" id="header-wrapper">
                    ...
                    <div className="header-right">
                        <nav className="mainmenunav d-lg-block">
                            ...
                            <li><Link to="/portfolio" style={{fontFamily:'Brice-Black', color: 'white'}}>Catalog</Link>
                                <ul className="submenu">
                                    <li><a href="/portfolio#riverTubes" style={{fontFamily:'Brice-Light', color: 'Black'}}>River Tubes</a></li>
                                    <li><a href="/portfolio#parkTubes" style={{fontFamily:'Brice-Light', color: 'Black'}}>Park Tubes</a></li>
                                    <li><a href="/portfolio#awesomeGear" style={{fontFamily:'Brice-Light', color: 'Black'}}>Awesome Gear</a></li>
                                </ul>
                                </li>
                                <li className="has-droupdown" style={{fontFamily:'Brice-Light', color: 'Black'}}><Link to="/" style={{fontFamily:'Brice-Light', color: 'white'}}>Home</Link>
                                    {/* <ul className="submenu">
                                ...
                                <li><Link to="/about" style={{fontFamily:'Brice-Light', color: 'white'}}>About</Link></li>
                                ...
                                <li><Link to="/contact" style={{fontFamily:'Brice-Light', color: 'white'}}>Contact</Link></li>
                            </ul>
                        </nav>
                        <div className="header-btn">
                            <a className="rn-btn" href="/portfolio">
                                <span style={{fontFamily:'Brice-Light', color: 'white'}}>Shop Now</span>
                            </a>
                        </div>
