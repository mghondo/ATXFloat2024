...
const singleDemo = [
  ...
  },
  {
    ...
    description:
      "Its a modern design with all realted features for creative agencies company.",
    label: "New",
  },
  {
  ...
  },
  {
    ...
    description:
      "Corporate Business is build for new or any startup business company. It has available all section for corporate business agency company and others business purpose.",
    label: "Hot",
  },
  {
    ...
    description:
      "A interior design comes for new interior agency company. Our can hire your clint by using this template. It has landing page feature available.",
    label: "New",
  },
  {
...

  {
    ...
    description:
      "Creative Portfolio is a awesome portfolio website demo. By using this you can be build a website for your portfolio",
    label: "",
  },
...

  {
    ...
    description:
      "Its a minimal portfolio template. You can be showing your portfolio perfectly by using this template.",
    label: "",
  },

  {
    ...
    description:
      "A Digital Agency template is a nice slider animation, faster loading and all features available for agencies.",
    label: "",
  },
  {
    url: "business",
    ...
    title: "Business",
    description:
      "It has available all kinds of features for a Business corporate website.You can be use it for your Business website.",
    label: "",
  },
  {
    url: "startup",
    ...
    title: "Startup",
    description:
      "A modern and nice design template that can be all startup agencies for all kinds of startup purpose.",
    label: "",
  },
  {
    url: "paralax",
    ...
    title: "Paralax Home",
    description:
      "Its a nice and awesome paralax background image design.You can be use it for Business, Corporate, Degital Agency and other so on.",
    label: "",
  },
  {
    url: "studio-agency",
    ...
    title: "Studio Agency",
    description:
      "It has been used background video and vedio popup.You can use it for all kinds of agencies studio.",
    label: "",
  },
  {
    url: "#comingsoon",
...
const agencyDemo = [
  ...
  },
  {
    ...
    title: "Creative Portfolio",
    description:
      "Creative Portfolio is a awesome portfolio website demo. By using this you can be display your portfolio and your companies project",
    label: "New",
  },
  {
    url: "studio-agency",
            ...
            <div className="wrapper plr--120">
                ...
                <div className="col-lg-12">
                  <div className="section-title text-center pb--30 pb_sm--0 pb_md--0">
                    ...
                    <p className="text-white">
                      Trydo are designed for everyone. It doesn’t matter if
                      you’re a React <br />
              ...
              <div className="row">
                ...
                {featureList.map((value, i) => (
                  <div
                    className="col-lg-6 col-xl-3 col-md-6 col-sm-6 col-12 mt--30"
                    key={i}
                  >
              ...
              <div className="row row--35">
                <div className="col-lg-6 col-md-12 col-12">
                  <div className="inner">
                    ...
                    <p>
                      Trydo Page speed is so faster and takes byte times for
                      load each page. It's is very easy to use, loads faster and
                      provides better performance for your wedsite.
                    </p>
                  </div>
                </div>
                  ...
                  <div className="inner">
                    <div className="section-title">
                      <h2 className="title theme-gradient">
                        Trydo works perfectly on any device.
                      </h2>
                      <p>
                        Trydo site works seamlessly on any device without a
                        single compromise, will always looks cool and great on
                        any mobile device or browsers. Its easily adapt your
                        content for mobile, tablet and so on.
                      </p>
                    </div>
                    <div className="responsive-layout-mokup">
                      ...
                      <div className="mokup-list">
                        <div className="icon">
                          <img
                            src="/assets/images/icons/tablet.png"
                            alt="icon Images"
                          />
                        </div>
                        <h6>Tablet</h6>
                      ...
                      <div className="mokup-list">
                        <div className="icon">
                          <img
                            src="/assets/images/icons/desktop.png"
                            alt="icon Images"
                          />
                        </div>
                        <h6>Desktop</h6>
                    ...
                    <p className="subtitle">
                      - Separate Options for Each Screen Size
                    </p>
                  </div>
                </div>
              </div>
                  ...
                  <div className="faq-area">
                    <Accordion className="accodion-style--1" preExpanded={"0"}>
                      ...
                      <AccordionItem>
                        ...
                        <AccordionItemPanel>
                          <p>
                            ...
                            First: <strong>yarn install</strong>
                          </p>
                          <p>
                            At Last: <strong>yarn start</strong>. By the
                      ...
                      <AccordionItem>
                        <AccordionItemHeading>
                          <AccordionItemButton>
                            3. How can I change my demo page instead of splash
                            page?
                          </AccordionItemButton>
                        </AccordionItemHeading>
                        <AccordionItemPanel>
                      ...
                      <AccordionItem>
                        <AccordionItemHeading>
                          <AccordionItemButton>
                            5. Can I get update regularly and For how long do I
                            get updates?
                          </AccordionItemButton>
                        </AccordionItemHeading>
                        <AccordionItemPanel>
                      ...
                      <AccordionItem>
                        <AccordionItemHeading>
                          <AccordionItemButton>
                            7. Can I build a complete project with this
                            template?
                          </AccordionItemButton>
                        </AccordionItemHeading>
                        <AccordionItemPanel>
                    ...
                    <div className="service">
                      ...
                      <div className="content">
                        ...
                        <a
                          target="_blank"
                          href="#"
                          className="rbt-button rn-button-style--2 rn-btn-small-2 btn-solid-border"
                        >
                    ...
                    <div className="service">
                      ...
                      <div className="content">
                        ...
                        <a
                          ...
                          className="rbt-button rn-button-style--2 rn-btn-small-2 btn-solid-border"
                        >
                          <span className="button-text">Get Support</span>
                        </a>
            ...
            <div className="row">
              <div className="col-lg-12">
                <div className="section-title text-center text-white">
                  ...
                  <p className="text-white">
                    Our Fantastic Trydo Template Elements
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="testimonial-area bg_color--1 pt--120 pb--150 pt_md--80 pb_md--110 pt_sm--80 pb_sm--110">
            <div className="container">
              ...
              <div className="row">
                <div className="col-lg-12">
                  <Slider
                    className="mt--30 mt_sm--5 mt_md--5 testimonial-activation rn-slick-dot slick-gutter-15"
                      ...
                      <div className="pv-testimonial">
                        <div className="inner">
                          ...
                          <div className="content">
                            ...
                            <p>
                              The product is of good quality and easy to use, We
                              are also the author on Envato and our requirement
                              is very high, Affordable and excellent...
                            </p>
                      ...
                      <div className="pv-testimonial">
                        <div className="inner">
                          ...
                          <div className="content">
                            <h5>Design Quality</h5>
                            <p>
                              The configuration of the contact form was
                              problematic, but the support of the Rainbow team
                              helped a lot. That convinced me! Thanks!
                            </p>
                            <div className="rating">
                              <img
                                src="/assets/images/icons/rating.png"
                      ...
                      <div className="pv-testimonial">
                        <div className="inner">
                          ...
                          <div className="content">
                            ...
                            <p>
                              Excellent design template and easy to customize if
                              you know React. Good value.
                            </p>
                            <div className="rating">
                              <img
                                src="/assets/images/icons/rating.png"
                      ...
                      <div className="pv-testimonial">
                        <div className="inner">
                          ...
                          <div className="content">
                            ...
                            <p>
                              Perfectly support. Well deserved 5 star for code
                              and design quality.
                            </p>
                            <div className="rating">
                              <img
                      ...
                      <div className="pv-testimonial">
                        <div className="inner">
                          ...
                          <div className="content">
                            <h5>Customer Support</h5>
                            <p>
                              The best customer support I've ever received on
                              Envato. The author is absolutely great and he's
                      ...
                      <div className="pv-testimonial">
                        <div className="inner">
                          ...
                          <div className="content">
                            <h5>Customer Support</h5>
                            <p>
                              Simply amazing support... TOP Seller in terms of
                              support... Thanks a lot... I will keep buying your
                              products... amazing work... bug free... thanks a
                              lot...
                            </p>
                            <div className="rating">
                              <img
