...
const photos = [
    {
        image: '02',
        bigImage: '/assets/images/NewImages10.23.2023/TUBES/Tubes_Single_Clear_JR_SC38/Tubes_Single_Clear_JR_SC38_Front.jpg',
        category: '',
        title: '',
    ...
    {
        image: '02',
        bigImage: '/assets/images/NewImages10.23.2023/TUBES/Tubes_Single_Clear_JR_SC38/Tubes_Single_Clear_JR_SC38_Back.jpg',
        category: '',
        title: '',
        css: {}, // Define the CSS properties as an object
    },
    {
        image: '02',
        bigImage: '/assets/images/NewImages10.23.2023/TUBES/Tubes_Single_Clear_JR_SC38/Tubes_Single_Clear_JR_SC38_Main.jpg',
        category: '',
        title: '',
        css: {}, // Define the CSS properties as an object
    },
...
class ParkSingleJR extends Component {
    constructor() {
        super()
        this.state = {
            isOpen: false
    ...
    render() {
        return (
            <React.Fragment>
                ...
                {/* <div className="rn-page-title-area pt--120 pb--190 bg_image" data-black-overlay="3" style={{ backgroundImage: `url(/assets/images/NewImages10.23.2023/TUBES/Tubes_Single_Clear_JR_SC38/Tubes_Single_Clear_JR_SC38_Front.jpg)`, backgroundPosition: 'center 50%'}}>
                    <div className="container">
                        <div className="row">
                            <div className="col-lg-12">
                                <div className="rn-page-title text-center pt--100">
                                    <h2 style={{ fontFamily: 'Brice-Black', }} className="title theme-gradient" data-aos="fade-down" data-aos-duration="750">Water Park Single JR Tubes</h2>
                                    <p style={{ fontFamily: 'Brice-Light', color: 'white' }} data-aos="fade-up" data-aos-duration="750"> Single Clear 42”-Child Size</p>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    >
        Thick Neoprene Can Cooler
                                        ...
                                        <h2  style={{ fontFamily: 'Brice-Black', textAlign: 'center', color:'#ef5474', textShadow: '2px 2px 4px rgba(0, 0, 0, 0.6)', fontSize: '2rem'}} className="title theme-gra dient" data-aos="fade-down" data-aos-duration="750">Water Park Single JR Tubes</h2>
                                    ...
                                    <div className="inner" >
                                        <div className="portfolio-view-list d-flex flex-wrap justify-content-center align-items-center" style={{ paddingTop: '30px' }}>
                                            <div className="port-view">
                                                ...
                                                <h4 style={{ color: 'black', fontFamily: 'Brice-Light' }}>SKU: ATX-SC38</h4>
                                            </div>

                                            <div className="port-view">
                                                <h4 style={{ color: 'black', fontFamily: 'Brice-Light', textAlign: 'center' }}>42” Deflated, 38” Inflated 17” inner, Inflated, 10” tall.</h4>
