...
const photos = [
    {
        image: '02',
        bigImage: '/assets/images/NewImages10.23.2023/TUBES/Tubes_Cooler_CTTO/Tubes_Cooler_CTTO_Main.jpg',
        category: '',
        title: '',
        css: {},
    }, 
    {
        image: '02',
        bigImage: '/assets/images/NewImages10.23.2023/TUBES/Tubes_Cooler_CTTO/Tubes_Cooler_CTTO_Side.jpg',
        category: '',
        title: '',
        css: {},
    },
...
class RiverCooler extends Component {
    constructor() {
        super()
        this.state = {
            isOpen: false
    ...
    render() {
        return (
            <React.Fragment>
                ...
                {/* <div className="rn-page-title-area pt--120 pb--190 bg_image" data-black-overlay="3" style={{ backgroundImage: `url(/assets/images/NewImages10.23.2023/TUBES/Tubes_Cooler_CTTO/Tubes_Cooler_CTTO_Main.jpg)` }}>
                    <div className="container">
                        <div className="row">
                            <div className="col-lg-12">
                                <div className="rn-page-title text-center pt--100">
                                    <h2 style={{ fontFamily: 'Brice-Black', }} className="title theme-gradient" data-aos="fade-down" data-aos-duration="750">River Cooler Tubes</h2>
                                    <p style={{ fontFamily: 'Brice-Light', color: 'white' }} data-aos="fade-up" data-aos-duration="750">48” x 36“ Inflated</p>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    >
        Thick Neoprene Can Cooler
                                        ...
                                        <h2  style={{ fontFamily: 'Brice-Black', textAlign: 'center', color:'#ef5474', textShadow: '2px 2px 4px rgba(0, 0, 0, 0.6)', fontSize: '2rem'}} className="title theme-gra dient" data-aos="fade-down" data-aos-duration="750">River Cooler Tubes</h2>
                                    ...
                                    <div className="inner" >
                                        <div className="portfolio-view-list d-flex flex-wrap justify-content-center align-items-center" style={{ paddingTop: '30px' }}>
                                            <div className="port-view">
                                                ...
                                                <h4 style={{ color: 'black', fontFamily: 'Brice-Light' }}>SKU: ATX-CTTO</h4>
                                            </div>
                                    ...
                                    <div className="port-view">
                                                ...
                                                Assorted Packaging: Retail Box: 4 pcs</h4>
                                            </div>
                                    <div className="inner" >
                                        <div className="portfolio-view-list d-flex flex-wrap justify-content-center align-items-center" style={{ paddingTop: '30px' }}>
                                            {/* <div className="port-view">
...
<p
                                        ...
                                        >
2 cup holders. 48” x 36“ Inflated. Heavy duty handles on each corner. Bottom support air chamber. 30-gauge heavy duty UV Vinyl (PVC). Double Seam Welds, Commercial Grade Boston Valve.
Colors available: Orange</p>
