...
class CustomRivertubes extends Component {
    constructor() {
        super()
        this.state = {
            isOpen: false
    ...
    >
        Thick Neoprene Can Cooler
                                        ...
                                        <h2  style={{ fontFamily: 'Brice-Black', textAlign: 'center', color:'#ef5474', textShadow: '2px 2px 4px rgba(0, 0, 0, 0.6)', fontSize: '2rem', paddingTop:'50px'}} className="title theme-gra dient" data-aos="fade-down" data-aos-duration="750">Custom Tubes</h2>
                                        ...
                                        <h2
                                            ...
                                            className="subtitle"
                                        >
                                            River-Grade | Consumer Retail Application
                                        </h2>
                                        <div className="subtitle" style={{ borderBottom: '1px solid #e2e0e0' }}>
                                        <CustomGalleryFromParent photos={photos} maxHeight="10rem" maxWidth="10rem" itemsPerPage='100' twopag='false'/>
                                    ...
                                    <div className="inner" >
                                        ...
                                        <div className="portfolio-view-list d-flex flex-wrap justify-content-center align-items-center" style={{ paddingTop: '10px' }}>
                                            ...
                                            <div className="port-view">
                                                <div className="text-center" style={{ display: 'block', marginBottom: '10px' }}>
                                                    <h4 style={{ color: 'black', fontFamily: 'Brice-Light', fontSize: '1rem' }}>
                                                    Custom Pay Terms: Please pay in advance of factory production. Price is FOB New Braunfels, Texas and may include additional freight to final destination. Pricing and details subject to change without notice.
                                        ...
                                        >
These tubes are made of a heavy duty, UV- resistant, 25-gauge Vinyl (PVC) material formulated to withstand long exposure in the sun, rock, sticks, and rough river conditions. With a 50-inch (deflated) outer diameter, 22-inch center diameter and the ergo’ backrest, these are the perfect size and height on the water to rest easy and comfortably for a long ride. Each tube comes with a large cup holder, 2 handles, mesh bottom, and a commercial Boston Air Valve for quick and easy inflation/deflation. Seams double welded to ensure no air leakage.
 </p>
<ul                                             style={{
                                                color: 'black',
                                                fontFamily: 'Brice-Light',
...
export default CustomRivertubes;
