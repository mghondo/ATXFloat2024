...
const photos = [
    {
        image: '02',
        bigImage: '/assets/images/NewImages10.23.2023/TUBES/Tubes_Double_Clear_JR_DC42-S/Tubes_Double_Clear_JR_DC42-S_Front.jpg',
        category: '',
        title: '',
    ...
    {
        image: '02',
        bigImage: '/assets/images/NewImages10.23.2023/TUBES/Tubes_Double_Clear_JR_DC42-S/Tubes_Double_Clear_JR_DC42-S_Back.jpg',
        category: '',
        title: '',
        css: {}, // Define the CSS properties as an object
    },
    {
        image: '02',
        bigImage: '/assets/images/NewImages10.23.2023/TUBES/Tubes_Double_Clear_JR_DC42-S/Tubes_Double_Clear_JR_DC42-S_Main.jpg',
        category: '',
        title: '',
        css: {}, // Define the CSS properties as an object
    },
...
class DoubleJR extends Component {
    constructor() {
        super()
        this.state = {
            isOpen: false
    ...
    render() {
        return (
            <React.Fragment>
                ...
                {/* <div className="rn-page-title-area pt--120 pb--190 bg_image" data-black-overlay="3" style={{ backgroundImage: `url(/assets/images/NewImages10.23.2023/TUBES/Tubes_Double_Clear_JR_DC42-S/Tubes_Double_Clear_JR_DC42-S_Front.jpg)`, backgroundPosition: 'center 50%'}}>
                        ...
                        <div className="row">
                            <div className="col-lg-12">
                                <div className="rn-page-title text-center pt--100">
                                    ...
                                    <p style={{ fontFamily: 'Brice-Light', color: 'white' }} data-aos="fade-up" data-aos-duration="750">  Double Clear 42” - Child Size</p>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    >
        Thick Neoprene Can Cooler
                                        ...
                                        <h2  style={{ fontFamily: 'Brice-Black', textAlign: 'center', color:'#ef5474', textShadow: '2px 2px 4px rgba(0, 0, 0, 0.6)', fontSize: '2rem'}} className="title theme-gra dient" data-aos="fade-down" data-aos-duration="750">Water Park Double Tubes</h2>
                                    ...
                                    <div className="inner" >
                                        <div className="portfolio-view-list d-flex flex-wrap justify-content-center align-items-center" style={{ paddingTop: '30px' }}>
                                            <div className="port-view">
                                                <h4 style={{ color: '#ef5474', fontFamily: 'Brice-Black', textAlign: 'center' }}>Clear Yellow</h4>
                                                <h4 style={{ color: 'black', fontFamily: 'Brice-Light' }}>SKU: ATX-DC42</h4>
                                            </div>
<br/>
                                    ...
                                    <div className="inner" >
                                        ...
                                        <div className="port-view">
                                                <h4 style={{ color: 'black', fontFamily: 'Brice-Light', textAlign: 'center' }}>42” Deflated, 69” inner, Deflated 11” tall.</h4>
...
without notice.
                                        ...
                                        >
Made of a crystal clear heavy duty UV resistant 30-gauge Vinyl (PVC) material formulated to withstand years of use in the waterpark. These are the perfect size and height. Each tube comes with 2 heavy duty handles and a Small Ribbed Plug Air Valve. The inside seam is a smooth inverted weld construction for comfort and protection. The outside seam is double welded to ensure no air leakage. Minimal print for visibility into the water below.</p>
<ul                                             style={{
                                                color: 'black',
                                                fontFamily: 'Brice-Light',
                                                fontSize:'20px',
