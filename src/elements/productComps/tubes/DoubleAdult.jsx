...
const photos = [
    {
        image: '02',
        bigImage: '/assets/images/NewImages10.23.2023/TUBES/Tubes_Double_Clear_DC48/Tubes_Double_Clear_DC48_Front.jpg',
        category: '',
        title: '',
    ...
    {
        image: '02',
        bigImage: '/assets/images/NewImages10.23.2023/TUBES/Tubes_Double_Clear_DC48/Tubes_Double_Clear_DC48_Back.jpg',
        category: '',
        title: '',
        css: {}, // Define the CSS properties as an object
    },
    {
        image: '02',
        bigImage: '/assets/images/NewImages10.23.2023/TUBES/Tubes_Double_Clear_DC48/Tubes_Double_Clear_DC48_Main.jpg',
        category: '',
        title: '',
        css: {}, // Define the CSS properties as an object
    },
...
class DoubleAdult extends Component {
    constructor() {
        super()
        this.state = {
            isOpen: false
    ...
    >
        Thick Neoprene Can Cooler
                                        ...
                                        <h2  style={{ fontFamily: 'Brice-Black', textAlign: 'center', color:'#ef5474', textShadow: '2px 2px 4px rgba(0, 0, 0, 0.6)', fontSize: '2rem'}} className="title theme-graient" data-aos="fade-down" data-aos-duration="750">Water Park Double Tubes</h2>
