...
const photos = [
    {
        image: '02',
        bigImage: '/assets/images/NewImages10.23.2023/Merchandise/Dry_Bag_15L_Holographic/Dry_Bag_15L_Holographic_Strap.jpg',
        category: 'Strap',
        title: '',
        css: {},
    },
    {
        image: '02',
        bigImage: '/assets/images/NewImages10.23.2023/Merchandise/Dry_Bag_15L_Holographic/Dry_Bag_15L_Holographic.jpg',
        category: '',
        title: '',
        css: {},
    },
...
class DryBagHolographic15 extends Component {
    constructor() {
        super()
        this.state = {
            isOpen: false
    ...
    render() {
        return (
            <React.Fragment>
                ...
                {/* <div className="rn-page-title-area pt--120 pb--190 bg_image" data-black-overlay="2" style={{ backgroundImage: `url(assets/images/NewImages10.23.2023/Merchandise/Dry_Bag_15L_Holographic/Dry_Bag_15L_Holographic.jpg)`, backgroundPosition: 'center 50%', }}>
                    <div className="container">
                        <div className="row">
                            <div className="col-lg-12">
                                <div className="rn-page-title text-center pt--100">
                                    <h2 style={{ fontFamily: 'Brice-Black', }} className="title theme-gradient" data-aos="fade-down" data-aos-duration="750">Dry Bag Holographic</h2>
    ...
    >
        Thick Neoprene Can Cooler
                                        ...
                                        <h2  style={{ fontFamily: 'Brice-Black', textAlign: 'center', color:'#ef5474', textShadow: '2px 2px 4px rgba(0, 0, 0, 0.6)', fontSize: '2rem'}} className="title theme-gra dient" data-aos="fade-down" data-aos-duration="750">Dry Bag Holographic</h2>
                                    ...
                                    <div className="inner" >
                                        <div className="portfolio-view-list d-flex flex-wrap justify-content-center align-items-center" style={{ paddingTop: '30px' }}>
                                            <div className="port-view">
                                                <h4 style={{ color: 'black', fontFamily: 'Brice-Light' }}>SKU: ATX-DB15LH</h4>
                                            </div>
                                        </div>
                                    </div>
                                    <div className="inner" >
            ...
            <img src="/assets/images/barCodes/solidDryBag.jpg" alt="" />
                                            ...
                                            <div className="port-view">
                                                <h4 style={{ color: 'black', fontFamily: 'Brice-Light', textAlign: 'center', fontSize: '1rem' }}>
                                                    Assorted Packaging:
                                                    Master Carton: 180pcs Inner Carton: 10pcs
                                                </h4>
                                            </div>
                                        </div>
...
export default DryBagHolographic15;
